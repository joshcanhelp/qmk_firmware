...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, BL_DOWN, BL_TOGG, BL_UP,   BL_STEP, _______, _______, _______, _______, KC_MEDIA_PLAY_PAUSE, KC_KB_VOLUME_UP, _______,
        _______, _______, _______,                   _______, _______, _______,                   _______, _______, _______, KC_MEDIA_PREV_TRACK, KC_KB_VOLUME_DOWN, KC_MEDIA_NEXT_TRACK
    ),
